      ...
      <div class="employee">
        <div class="grid">
          <div class="member">
            ...
            <p class="role">Chức vụ :Founder , Chủ tịch HDQT </p>
            <p class="email"> Email : doannvph27169@fpt.edu.vn</p>
          </div>
          <div class="member">
            <img style="width: 200px;height: 300px" src="./images/phucnq.jpg" alt="">
            <p class="name"> Nguyễn Quang Phúc </p>
            <p class="role">Chức vụ :Quản lý sản phẩm </p>
            <p class="email"> Email : nquangphuc0501@gmail.com</p>
          </div>
          <div class="member">
            <img style="width: 200px;height: 300px" src="./images/huytq.jpg" alt="">
            <p class="name"> Tạ Quang Huy </p>
            <p class="role">Chức vụ : Creator , Quản lý data</p>
            <p class="email"> Email : daodnph27226@gmail.com</p>
          </div>
          <div class="member">
            <img style="width: 200px;height: 300px" src="./images/daodn.jpg" alt="">
            <p class="name"> Dương Ngọc Đạo </p>
